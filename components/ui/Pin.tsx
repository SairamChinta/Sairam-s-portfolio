  ...
  return (
    <motion.div className="pointer-events-auto w-full h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className="w-full h-full -mt-7 flex-none inset-0">
        ...
        {/* Glowing pin shaft only */}
        <motion.div className="absolute right-1/2 bottom-1/2 bg-gradient-to-b from-transparent to-cyan-500 translate-y-[14px] w-[1.5px] h-32 group-hover/pin:h-40 blur-[1px]" />
        <motion.div className="absolute right-1/2 bottom-1/2 bg-gradient-to-b from-transparent to-cyan-400 translate-y-[14px] w-[1px] h-32 group-hover/pin:h-40" />
      </div>
    </motion.div>
  );
};
